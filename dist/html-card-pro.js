import{html as t,LitElement as e}from"https://unpkg.com/lit-element@2.4.0/lit-element.js?module";const s="3.3.0";console.info(`%c HTML-PRO-CARD %c v${s} `,"background:#03a9f4;color:#fff;font-weight:bold;","background:#333;color:#fff;");const i=window._htmlProCardScripts||(window._htmlProCardScripts=new Set);if(!document.getElementById("html-pro-card-overlay")){const t=document.createElement("div");t.id="html-pro-card-overlay",t.style.cssText="position:fixed;top:0;left:0;width:100%;height:100%;pointer-events:none;z-index:2147483647;overflow:hidden;",document.body.appendChild(t)}if(window._htmlProCardOverlay=document.getElementById("html-pro-card-overlay"),function(){const t=window._htmlProCardOverlay;if(!t)return;const e=()=>{t.innerHTML="",document.querySelectorAll('[id^="claw-"]').forEach(t=>t.remove()),s.style.display="none"};window.addEventListener("location-changed",e);const s=document.createElement("div");s.id="claw-overlay-close",s.style.cssText="position:fixed;bottom:24px;right:24px;z-index:2147483647;width:40px;height:40px;border-radius:50%;background:var(--error-color,#e53935);color:#fff;display:none;align-items:center;justify-content:center;cursor:pointer;pointer-events:auto;font-size:20px;line-height:1;box-shadow:0 2px 8px rgba(0,0,0,.3);",s.innerHTML="✕",s.onclick=e,document.body.appendChild(s),new MutationObserver(()=>{s.style.display=t.children.length?"flex":"none"}).observe(t,{childList:!0})}(),!window._htmlProCardRoots){window._htmlProCardRoots=new Set;const t=document.getElementById.bind(document),e=document.querySelector.bind(document),s=document.querySelectorAll.bind(document);document.getElementById=function(e){for(const t of window._htmlProCardRoots){const s=t.querySelector("#"+e);if(s)return s}return t(e)},document.querySelector=function(t){for(const e of window._htmlProCardRoots){const s=e.querySelector(t);if(s)return s}return e(t)},document.querySelectorAll=function(t){const e=[];for(const s of window._htmlProCardRoots)e.push(...s.querySelectorAll(t));return e.length>0?e:s(t)}}const o={promise:null};customElements.get("ha-htmlcard-textarea")||customElements.define("ha-htmlcard-textarea",class extends HTMLElement{constructor(){super(),this._value="",this._editorReady=!1,this._pendingValue=null}connectedCallback(){this._initialized||(this._initialized=!0,this.innerHTML="\n        <style>\n          .pce-container {\n            border: 1px solid var(--divider-color, #e0e0e0);\n            border-radius: 8px;\n            overflow: hidden;\n          }\n          .pce-container .prism-code-editor {\n            height: 400px !important;\n            min-height: 400px !important;\n            font-size: 13px !important;\n          }\n          .pce-fallback {\n            width: 100%;\n            height: 400px;\n            padding: 12px;\n            border: none;\n            background: var(--card-background-color, #fff);\n            color: var(--primary-text-color, #333);\n            font-family: 'SF Mono', 'Consolas', 'Monaco', monospace;\n            font-size: 13px;\n            resize: vertical;\n            box-sizing: border-box;\n          }\n        </style>\n        <div class=\"pce-container\">\n          <textarea class=\"pce-fallback\" spellcheck=\"false\"></textarea>\n        </div>\n      ",this._container=this.querySelector(".pce-container"),this._fallback=this.querySelector(".pce-fallback"),this._fallback.value=this._value,this._fallback.addEventListener("input",()=>{this._value=this._fallback.value,this.dispatchEvent(new CustomEvent("change",{detail:{value:this._value},bubbles:!0,composed:!0}))}),this._initEditor())}async _initEditor(){try{const t=await(o.promise||(o.promise=new Promise(t=>{if(window.prismCodeEditor)return void t(window.prismCodeEditor);const e=document.createElement("script");e.type="module",e.textContent="\n      import { fullEditor, updateTheme } from 'https://cdn.jsdelivr.net/npm/prism-code-editor@3/dist/setups/index.js';\n      import 'https://cdn.jsdelivr.net/npm/prism-code-editor@3/dist/prism/languages/markup.js';\n      import 'https://cdn.jsdelivr.net/npm/prism-code-editor@3/dist/prism/languages/css.js';\n      import 'https://cdn.jsdelivr.net/npm/prism-code-editor@3/dist/prism/languages/javascript.js';\n      window.prismCodeEditor = { fullEditor, updateTheme };\n      window.dispatchEvent(new Event('pce-ready'));\n    ",document.head.appendChild(e),window.addEventListener("pce-ready",()=>t(window.prismCodeEditor),{once:!0})})),o.promise);this._fallback.style.display="none";const e=null!==this._pendingValue?this._pendingValue:this._value,s=document.querySelector("home-assistant")?.hass?.themes,i=s?.darkMode||document.body.getAttribute("data-theme")?.includes("dark")||getComputedStyle(document.body).getPropertyValue("--primary-background-color")?.trim()?.match(/^#[0-3]/)||window.matchMedia("(prefers-color-scheme: dark)").matches?"vs-code-dark":"vs-code-light";this._editor=t.fullEditor(this._container,{language:"html",theme:i,value:e,lineNumbers:!0,wordWrap:!1,tabSize:2},()=>{this._editorReady=!0,this._value=e;const t=this._editor.scrollContainer.parentNode;if(t instanceof ShadowRoot){const e=document.createElement("style");e.textContent=".prism-code-editor { height: 400px !important; font-size: 13px !important; }",t.appendChild(e)}this._editor.addListener("update",t=>{this._value=t,this.dispatchEvent(new CustomEvent("change",{detail:{value:this._value},bubbles:!0,composed:!0}))})})}catch(t){this._fallback.style.display="block"}}set value(t){const e=t||"";this._editorReady&&this._editor?this._editor.value!==e&&(this._editor.setOptions({value:e}),this._value=e):(this._pendingValue=e,this._value=e,this._fallback&&(this._fallback.value=e))}get value(){return this._value}}),customElements.get("ha-htmlcard-textfield")||customElements.define("ha-htmlcard-textfield",class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML='\n        <style>\n          :host {\n            display: block;\n          }\n          input {\n            width: 100%;\n            padding: 8px;\n            border: 1px solid var(--divider-color, #e0e0e0);\n            border-radius: 4px;\n            background: var(--card-background-color, #fff);\n            color: var(--primary-text-color, #000);\n          }\n        </style>\n        <input type="text" />\n      ',this._input=this.shadowRoot.querySelector("input"),this._input.addEventListener("input",()=>{this.dispatchEvent(new CustomEvent("change",{detail:{value:this._input.value},bubbles:!0,composed:!0}))})}set value(t){this._input.value=t}get value(){return this._input.value}set type(t){this._input.type=t}}),customElements.get("ha-htmlcard-switch")||customElements.define("ha-htmlcard-switch",class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML='\n        <style>\n          :host {\n            display: inline-block;\n          }\n          label {\n            position: relative;\n            display: inline-block;\n            width: 40px;\n            height: 24px;\n          }\n          input {\n            opacity: 0;\n            width: 0;\n            height: 0;\n          }\n          span {\n            position: absolute;\n            cursor: pointer;\n            top: 0;\n            left: 0;\n            right: 0;\n            bottom: 0;\n            background-color: #ccc;\n            transition: .4s;\n            border-radius: 24px;\n          }\n          span:before {\n            position: absolute;\n            content: "";\n            height: 16px;\n            width: 16px;\n            left: 4px;\n            bottom: 4px;\n            background-color: white;\n            transition: .4s;\n            border-radius: 50%;\n          }\n          input:checked + span {\n            background-color: var(--primary-color, #03a9f4);\n          }\n          input:checked + span:before {\n            transform: translateX(16px);\n          }\n        </style>\n        <label>\n          <input type="checkbox" />\n          <span></span>\n        </label>\n      ',this._input=this.shadowRoot.querySelector("input"),this._input.addEventListener("change",()=>{this.dispatchEvent(new CustomEvent("change",{detail:{checked:this._input.checked},bubbles:!0,composed:!0}))})}set checked(t){this._input.checked=t}get checked(){return this._input.checked}}),customElements.get("ha-htmlcard-formfield")||customElements.define("ha-htmlcard-formfield",class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML='\n        <style>\n          :host {\n            display: flex;\n            align-items: center;\n            padding: 4px 0;\n          }\n          label {\n            padding-left: 8px;\n            color: var(--primary-text-color, #000);\n          }\n        </style>\n        <slot></slot>\n        <label><slot name="label"></slot></label>\n      '}});const n={zh:{htmlContent:"HTML 内容",options:"选项设置",scripts:"外部脚本",store:"模块商店",disableParse:"纯HTML模式",disableParseDesc:"默认关闭(使用Jinja2)，开启后直接渲染HTML",updateInterval:"更新间隔 (ms)",updateIntervalDesc:"0 为禁用自动更新",ignoreLineBreaks:"忽略换行",ignoreLineBreaksDesc:"忽略HTML中的换行符",addScript:"添加",scriptPlaceholder:"输入脚本 URL",searchPlaceholder:"搜索模块...",import:"导入",delete:"删除",loading:"加载中...",noModules:"暂无模块",noCustomModules:"暂无自定义模块",confirmDelete:"确定删除此模块?",customModule:"自定义模块",headerDesc:"高级 HTML 卡片编辑器，支持 Jinja2 模板语法",headerDesc2:"可使用 Home Assistant 状态、属性和服务调用",realtime:"实时更新",extScripts:"外部脚本",customStyle:"自定义样式",yamlHint:"支持直接粘贴完整YAML配置"},en:{htmlContent:"HTML Content",options:"Options",scripts:"External Scripts",store:"Module Store",disableParse:"Pure HTML Mode",disableParseDesc:"Off by default (uses Jinja2), enable to render HTML directly",updateInterval:"Update Interval (ms)",updateIntervalDesc:"0 to disable auto update",ignoreLineBreaks:"Ignore Line Breaks",ignoreLineBreaksDesc:"Ignore line breaks in HTML",addScript:"Add",scriptPlaceholder:"Enter script URL",searchPlaceholder:"Search modules...",import:"Import",delete:"Delete",loading:"Loading...",noModules:"No modules",noCustomModules:"No custom modules",confirmDelete:"Delete this module?",customModule:"Custom Module",headerDesc:"Advanced HTML card editor with Jinja2 template",headerDesc2:"Use Home Assistant states, attributes and services",realtime:"Realtime",extScripts:"Scripts",customStyle:"Custom CSS",yamlHint:"Paste full YAML config directly"}};customElements.define("html-pro-card-editor",class extends e{static get properties(){return{_config:{type:Object},hass:{type:Object},_showStore:{type:Boolean},_showHtml:{type:Boolean},_showOptions:{type:Boolean},_showScripts:{type:Boolean},_storeModules:{type:Array},_savedModules:{type:Array},_storeLoading:{type:Boolean},_storeSearch:{type:String}}}get _lang(){return this.hass?.language?.startsWith("zh")?"zh":"en"}_t(t){return n[this._lang]?.[t]||n.en[t]||t}constructor(){super(),this._showStore=!1,this._showHtml=!0,this._showOptions=!1,this._showScripts=!1,this._storeModules=[],this._savedModules=this._loadSavedModules(),this._storeLoading=!1,this._storeSearch=""}_loadSavedModules(){try{const t=localStorage.getItem("html-pro-card-modules");return t?JSON.parse(t):[]}catch{return[]}}_saveSavedModules(){localStorage.setItem("html-pro-card-modules",JSON.stringify(this._savedModules))}setConfig(t){this._config=t}render(){return this._config?t`
      ...
      <div class="card-config">
        ...
        <div class="header-section">
          <a href="https://github.com/knoop7/html-card-pro" target="_blank" class="header-version" style="text-decoration:none;color:#fff;">v${s}</a>
        ...
        <div class="collapse-panel">
          ...
          <div class="collapse-body ${this._showScripts?"expanded":""}">
            <div class="collapse-content">
              ...
              ${(this._config.scripts||[]).map((e,s)=>t`
                <div class="script-item">
                  <ha-textfield
                    type="url"
                    .value="${e}"
                    @change="${t=>this._updateScript(s,t.target.value)}"
                  ></ha-textfield>
                  <mwc-icon-button @click="${()=>this._removeScript(s)}">
          ...
          <div class="collapse-body ${this._showStore?"expanded":""}">
            <div class="collapse-content">
              ...
              <div class="store-list">
                ${this._storeLoading?t`<div class="store-loading">${this._t("loading")}</div>`:this._renderOnlineModules()}
              </div>
            </div>
          </div>
        </div>
